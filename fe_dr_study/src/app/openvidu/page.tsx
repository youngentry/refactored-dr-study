...
import AudioRecorder from './mic-record-test/page';
import { LiveKitRoom } from '@livekit/components-react';
import LKRoom from './_components/LiveKitRoom';
...
function configureUrls() {
    ...
    if (!APPLICATION_SERVER_URL) {
        ...
        APPLICATION_SERVER_URL =
            'https://192-168-100-137.openvidu-local.dev:6443/';
        // } else {
        // APPLICATION_SERVER_URL =
    ...
    LIVEKIT_URL = 'wss://192-168-100-137.openvidu-local.dev:7443/';
    // }
    // else {
