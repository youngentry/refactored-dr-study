...
@Getter
@Builder
public class GetStudyGroupPageResponse {
    ...
    @Schema(description = "현재 스터디그룹 인원", example = "6")
    private final Integer memberCount;

    public static GetStudyGroupPageResponse of(StudyGroup studyGroup, Integer memberCount){
