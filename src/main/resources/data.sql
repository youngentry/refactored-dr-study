...
INSERT INTO avatar (creator_id, character_type, model_type, voice_type, created_at) VALUES
(1 + FLOOR(RAND() * 6), SUBSTRING('ABCDEF', FLOOR(1 + RAND() * 6), 1), SUBSTRING('ABC', FLOOR(1 + RAND() * 3), 1), SUBSTRING('ABC', FLOOR(1 + RAND() * 3), 1), NOW()),
(1 + FLOOR(RAND() * 6), SUBSTRING('ABCDEF', FLOOR(1 + RAND() * 6), 1), SUBSTRING('ABC', FLOOR(1 + RAND() * 3), 1), SUBSTRING('ABC', FLOOR(1 + RAND() * 3), 1), NOW()),
(1 + FLOOR(RAND() * 6), SUBSTRING('ABCDEF', FLOOR(1 + RAND() * 6), 1), SUBSTRING('ABC', FLOOR(1 + RAND() * 3), 1), SUBSTRING('ABC', FLOOR(1 + RAND() * 3), 1), NOW()),
(1 + FLOOR(RAND() * 6), SUBSTRING('ABCDEF', FLOOR(1 + RAND() * 6), 1), SUBSTRING('ABC', FLOOR(1 + RAND() * 3), 1), SUBSTRING('ABC', FLOOR(1 + RAND() * 3), 1), NOW()),
(1 + FLOOR(RAND() * 6), SUBSTRING('ABCDEF', FLOOR(1 + RAND() * 6), 1), SUBSTRING('ABC', FLOOR(1 + RAND() * 3), 1), SUBSTRING('ABC', FLOOR(1 + RAND() * 3), 1), NOW()),
